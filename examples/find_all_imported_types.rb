# Example usage of the class analysis features. After defining a classpath, use
# dependency analysis to find all used classes of a codebase. This code uses 
# in turn the method imported_3rd_party_types of 
