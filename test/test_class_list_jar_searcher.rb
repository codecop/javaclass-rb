...
require 'javaclass/analyse/class_list_jar_searcher'
require 'javaclass/classpath/jar_classpath'

module TestJavaClass
  module TestAnalyse
    class TestClassListJarSearcher < Test::Unit::TestCase
      ...
      def setup
        @cs = JavaClass::Analyse::ClassListJarSearcher.new
      end
      ...
      def test_public_eh
        @cpe = JavaClass::Classpath::JarClasspath.new(File.expand_path("#{TEST_DATA_PATH}/jar_class_list/JarClassListTest.jar"))
      ...
      def test_skip_package_classes_equals
        ...
        list = @cs.compile_list(3, "#{TEST_DATA_PATH}/jar_class_list", MockList.new )
